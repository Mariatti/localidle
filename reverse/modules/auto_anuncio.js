/* TB-WM u=179 e=a07d5b4cfa x=f2e5047b9289 t=1786720279 s=d4413e6cd855da02 */
(function(){try{window.__TIBIABOT_WM__={u:179,t:1786720279,x:"f2e5047b9289",s:"d4413e6cd855da02"};}catch(e){}})();
...
// MÃ³dulo Baiak Idle (MAIN): Auto AnÃºncio
// - Canal: .chat-tab[data-tab]
// - Mensagem: #chat-input (mÃ¡x. 200) + Enter
...
(function () {
    ...
    class BaiakIdleAutoAnuncioModule {
        ...
        start() {
            ...
            this._busy = false;
            this._lastStatusKey = '';
            // Envia assim que ativar (se jÃ¡ nÃ£o houver cooldown desta sessÃ£o).
            if (!this._getNextAt()) {
                this._setNextAt(0);
            }
            this._startStatusTicker();
    ...
    try {
        ...
        console.error('[BaiakIdle Auto AnÃºncio] Falha no bootstrap', err);
    }
})();
