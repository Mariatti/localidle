/* TB-WM u=179 e=a07d5b4cfa x=f2e5047b9289 t=1786720265 s=e6fcc2d2a34edf98 */
(function(){try{window.__TIBIABOT_WM__={u:179,t:1786720265,x:"f2e5047b9289",s:"e6fcc2d2a34edf98"};}catch(e){}})();
...
// MÃ³dulo Baiak Idle (MAIN): Pular Boss
// - Detecta bossbar â Cidade (confirma DOM) â hunt ativa
    ...
    class BaiakIdlePularBossModule {
        ...
        _verificarBossBar() {
            ...
            try {
                const S = this._sel();
                if (!S?.PULAR_BOSS) {
                    this._log('BaiakIdleSeletores.PULAR_BOSS indisponÃ­vel');
                    return false;
                }
                ...
                this._log('BossBar detectada! Cidade â hunt ativa...');
