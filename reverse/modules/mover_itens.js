/* TB-WM u=179 e=a07d5b4cfa x=f2e5047b9289 t=1786720270 s=b9fc8336c9c2d0b3 */
(function(){try{window.__TIBIABOT_WM__={u:179,t:1786720270,x:"f2e5047b9289",s:"b9fc8336c9c2d0b3"};}catch(e){}})();
    ...
    class BaiakIdleMoverItensModule {
        ...
        async _moveMatching() {
            ...
            if (!S?.ITEMS || typeof S.findInvItemsByTiers !== 'function') {
                this._log('Seletores ITEMS indisponÃ­veis');
                return;
            }
        ...
        start() {
            ...
            this._running = true;
            this._busy = false;
            this._log('MÃ³dulo iniciado', { tiers: this._enabledTiers() });
