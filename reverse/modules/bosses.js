/* TB-WM u=179 e=a07d5b4cfa x=f2e5047b9289 t=1786720282 s=28fb63caf59bd729 */
(function(){try{window.__TIBIABOT_WM__={u:179,t:1786720282,x:"f2e5047b9289",s:"28fb63caf59bd729"};}catch(e){}})();

/**
 * CatÃ¡logo exclusivo de bosses Baiak-Idle (AutoBoss).
 * MÃ³dulo interno servido por /api/bosses.php (nÃ£o empacotar na extensÃ£o).
 * Fonte Ãºnica: adicione/edite bosses aqui a partir do HTML da cyclopedia.
 *
 * Imagens de itens: sempre https://baiakidle.com/api/things/object/{id}.png
 * (sem ?v=)
 *
 * sprite: URL externa (ex.: TibiaWiki) â canvas do jogo nÃ£o traz src.
 */
(function (root) {
   ...
   *   damageElements?: Array<{ element: string, weight?: number }>,
   *   drops: {
   *     common: BossDrop[],
   *     uncommon?: BossDrop[],
   *     semiRare?: BossDrop[],
  ...
  const BOSSES = [
    {
      ...
      // HTML da cyclopedia vinha com store-name "?" (ainda nÃ£o revelado na conta).
      // Identificado por summons Falcon + loot Falcon â Grand Master Oberon.
      ...
      damageElements: [{ element: 'physical', weight: 1200 }, { element: 'earth', weight: 850 }, { element: 'holy', weight: 650 }, { element: 'death', weight: 500 }],
      resistances: [
    ...
    },
    {
      ...
      // Identificado por summons Deepling + loot deepling â Brokul.
      name: 'Brokul',
      rarity: 'archfoe',
      rarityLabel: 'Archfoe',
      hp: 75000,
      ...
      damageElements: [{ element: 'fire', weight: 1108 }, { element: 'death', weight: 500 }, { element: 'holy', weight: 500 }, { element: 'physical', weight: 500 }],
      resistances: [
      ...
      drops: {
        ...
        semiRare: [
          ...
          // HTML vinha com data:image; ID padrÃ£o Tibia do gold ingot.
    ...
    },
    {
      ...
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot urmahlullu's paw/mane/tail â Urmahlullu the Weakened.
      ...
      drops: {
        ...
        semiRare: [
          ...
          { name: 'giant sapphire', objectId: 30061 },
          { name: 'ring of secret thoughts', objectId: 31263 },
          { name: "urmahlullu's mane", objectId: 31623 },
          { name: 'giant emerald', objectId: 30060 },
          { name: 'giant ruby', objectId: 30059 },
    ...
    },
    {
      id: 'scarlett_etzel',
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot cobra set â Scarlett Etzel.
      name: 'Scarlett Etzel',
      rarity: 'bane',
      rarityLabel: 'Bane',
      hp: 45000,
      ...
      damageElements: [{ element: 'earth', weight: 8300 }, { element: 'physical', weight: 1150 }, { element: 'death', weight: 800 }, { element: 'holy', weight: 600 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por summons Elite Pirat + loot ratmiral/pirate â Ratmiral Blackwhiskers.
    ...
    },
    {
      ...
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot beast's nightmare-cushion / dark whispers â The Nightmare Beast.
      ...
      damageElements: [{ element: 'death', weight: 4000 }, { element: 'physical', weight: 500 }],
      resistances: [
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 300 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      drops: {
        ...
        semiRare: [
          ...
          { name: 'giant amethyst', objectId: 32622 },
    ...
    },
    {
      ...
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por resists +80% elementais + loot part of a rune / phoenix shield â The Time Guardian.
      ...
      damageElements: [{ element: 'fire', weight: 850 }, { element: 'physical', weight: 750 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'death', weight: 300 }],
      resistances: [
    ...
    },
    {
      id: 'ghulosh',
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot epaulette / unliving demonbone â Ghulosh.
      name: 'Ghulosh',
      rarity: 'archfoe',
      rarityLabel: 'Archfoe',
      hp: 450000,
      ...
      damageElements: [{ element: 'physical', weight: 1450 }, { element: 'death', weight: 1400 }, { element: 'earth', weight: 450 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
    ...
    },
    {
      id: 'lokathmor',
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot sturdy book + resists Earth/Energy fracos â Lokathmor.
      name: 'Lokathmor',
      rarity: 'archfoe',
      rarityLabel: 'Archfoe',
      hp: 450000,
    ...
    },
    {
      id: 'mazzinor',
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot energy (frozen lightning, lightning boots) + sinister book + wand of dimensions â Mazzinor.
      name: 'Mazzinor',
      rarity: 'archfoe',
      rarityLabel: 'Archfoe',
      hp: 450000,
    ...
    },
    {
      ...
      damageElements: [{ element: 'death', weight: 17000 }, { element: 'earth', weight: 14000 }, { element: 'fire', weight: 6000 }, { element: 'energy', weight: 5000 }, { element: 'physical', weight: 1500 }],
      resistances: [
    ...
    },
    {
      ...
      damageElements: [{ element: 'earth', weight: 750 }, { element: 'physical', weight: 700 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 15, kind: 'resistente' },
        { element: 'earth', value: 40, kind: 'resistente' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'earth', weight: 1485 }, { element: 'fire', weight: 786 }, { element: 'physical', weight: 456 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 5, kind: 'resistente' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot forbidden tome / key to knowledge / hammer of prophecy / umbral hammer â The Last Lore Keeper.
      ...
      damageElements: [{ element: 'energy', weight: 2596 }, { element: 'physical', weight: 1000 }, { element: 'earth', weight: 700 }],
      resistances: [
        { element: 'physical', value: 20, kind: 'resistente' },
        { element: 'energy', value: 20, kind: 'resistente' },
        { element: 'earth', value: 20, kind: 'resistente' },
    ...
    },
    {
      ...
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot spark sphere / calamity / library ticket / instable proto matter â The Scourge of Oblivion.
      ...
      damageElements: [{ element: 'physical', weight: 1400 }, { element: 'death', weight: 1250 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot ferumbras' hat / staff / amulet / mana keg / boots of homecoming / scroll of ascension â Ferumbras Mortal Shell.
      ...
      damageElements: [{ element: 'death', weight: 2000 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 1000 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 600 }],
      resistances: [
    ...
    },
    {
      ...
      damageElements: [{ element: 'death', weight: 1400 }, { element: 'physical', weight: 600 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 925 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 10, kind: 'resistente' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'energy', weight: 700 }, { element: 'death', weight: 525 }, { element: 'physical', weight: 525 }],
      resistances: [
        { element: 'physical', value: 50, kind: 'resistente' },
        { element: 'energy', value: 50, kind: 'resistente' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      drops: {
        ...
        uncommon: [
          { name: 'amber with a bug', objectId: 32624 },
          { name: 'giant topaz', objectId: 32623 }
        ],
        semiRare: [{ name: 'amber crusher', objectId: 46628 }],
        rare: [
          { name: 'amber axe', objectId: 47375 },
          { name: 'amber greataxe', objectId: 47369 },
          { name: 'amber slayer', objectId: 47368 },
          { name: 'amber sabre', objectId: 47374 },
          { name: 'amber cudgel', objectId: 47376 },
          { name: 'amber bludgeon', objectId: 47370 },
          { name: 'amber bow', objectId: 47371 },
          { name: 'amber crossbow', objectId: 47377 },
          { name: 'amber wand', objectId: 47372 },
          { name: 'amber rod', objectId: 47373 },
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 1000 }, { element: 'death', weight: 800 }, { element: 'energy', weight: 500 }, { element: 'ice', weight: 500 }],
      resistances: [
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 365 }],
      resistances: [
        { element: 'physical', value: 50, kind: 'resistente' },
        { element: 'energy', value: 50, kind: 'resistente' },
        { element: 'earth', value: 50, kind: 'resistente' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'death', weight: 2300 }, { element: 'ice', weight: 1300 }, { element: 'physical', weight: 1200 }, { element: 'earth', weight: 800 }],
      resistances: [
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 677 }, { element: 'ice', weight: 268 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: -5, kind: 'fraco' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 1500 }, { element: 'fire', weight: 900 }, { element: 'death', weight: 350 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 1200 }, { element: 'energy', weight: 550 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      drops: {
        ...
        uncommon: [
          { name: 'divine plate', objectId: 8057 },
          // HTML vinha com data:image; ID padrÃ£o Tibia do dragonbone staff.
        ...
        semiRare: [
          ...
          // HTML vinha com data:image (sem /api/things)
          { name: 'exalted seal', objectId: 44750 },
    ...
    },
    {
      ...
      damageElements: [{ element: 'earth', weight: 1700 }, { element: 'physical', weight: 600 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 10, kind: 'resistente' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 1032 }, { element: 'earth', weight: 650 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'death', weight: 1700 }, { element: 'energy', weight: 600 }, { element: 'physical', weight: 500 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: -20, kind: 'fraco' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'fire', weight: 2000 }, { element: 'ice', weight: 2000 }, { element: 'physical', weight: 2000 }, { element: 'death', weight: 1800 }, { element: 'earth', weight: 600 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 5, kind: 'resistente' },
        { element: 'earth', value: 80, kind: 'resistente' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'fire', weight: 577 }, { element: 'energy', weight: 273 }, { element: 'physical', weight: 230 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      id: 'lady_tenebris',
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot shadow mask / shadow paint / book of lies / cluster of solace â Lady Tenebris.
      name: 'Lady Tenebris',
      rarity: 'archfoe',
      rarityLabel: 'Archfoe',
      hp: 225000,
      ...
      damageElements: [{ element: 'physical', weight: 1800 }, { element: 'death', weight: 606 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 5, kind: 'resistente' },
        { element: 'earth', value: 20, kind: 'resistente' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'fire', weight: 1500 }, { element: 'physical', weight: 325 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 5, kind: 'resistente' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      id: 'duke_krule',
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot noble amulet / rotten heart / bear skin â Duke Krule.
      name: 'Duke Krule',
      rarity: 'archfoe',
      rarityLabel: 'Archfoe',
      hp: 435000,
      ...
      drops: {
        ...
        semiRare: [
          ...
          // HTML vinha com data:image (sem /api/things); 31593 no HTML Ã© noble cape.
    ...
    },
    {
      ...
      damageElements: [{ element: 'death', weight: 3500 }, { element: 'physical', weight: 500 }],
      resistances: [
        { element: 'physical', value: 10, kind: 'resistente' },
      ...
      drops: {
        ...
        rare: [
          ...
          // HTML vinha com data:image; IDs no intervalo eldritch jÃ¡ usado no Baiak.
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 783 }, { element: 'ice', weight: 619 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'ice', weight: 1348 }, { element: 'physical', weight: 1000 }, { element: 'earth', weight: 800 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: -5, kind: 'fraco' },
        { element: 'earth', value: 50, kind: 'resistente' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'earth', weight: 2800 }, { element: 'physical', weight: 1000 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 5, kind: 'resistente' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      id: 'the_unwelcome',
      // HTML da cyclopedia vinha com store-name "?".
      // Identificado por loot soulful legs / fabulous legs + todas resistÃªncias +40%.
      name: 'The Unwelcome',
      rarity: 'archfoe',
      rarityLabel: 'Archfoe',
      hp: 450000,
    ...
    },
    {
      ...
      damageElements: [{ element: 'death', weight: 2000 }, { element: 'physical', weight: 1000 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 5, kind: 'resistente' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'earth', weight: 4010 }, { element: 'energy', weight: 1221 }, { element: 'fire', weight: 968 }, { element: 'physical', weight: 763 }, { element: 'death', weight: 276 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: -5, kind: 'fraco' },
        { element: 'earth', value: 0, kind: 'neutro' },
      ...
      drops: {
        ...
        uncommon: [
          { name: 'mastermind potion', objectId: 7440 },
          { name: 'giant amethyst', objectId: 32622 },
          { name: 'royal almandine', objectId: 39038 }
        ],
        semiRare: [
          { name: 'giant ruby', objectId: 30059 },
          { name: 'giant emerald', objectId: 30060 },
        ...
        rare: [
          { name: 'arboreal tome', objectId: 39154 },
          { name: 'arboreal crown', objectId: 39153 },
          { name: 'spiritthorn armor', objectId: 39147 },
          { name: 'spiritthorn helmet', objectId: 39148 },
          { name: 'alicorn headguard', objectId: 39149 },
          { name: 'alicorn quiver', objectId: 39150 },
          { name: 'arcanomancer regalia', objectId: 39151 },
          { name: 'arcanomancer folio', objectId: 39152 },
          { name: 'charged arcanomancer sigil', objectId: 39183 },
          { name: 'charged arboreal ring', objectId: 39186 },
          { name: 'charged alicorn ring', objectId: 39180 },
          { name: 'charged spiritthorn ring', objectId: 39177 }
        ]
      }
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 1300 }],
      resistances: [
      ...
      drops: {
        ...
        uncommon: [
          ...
          { name: 'ultimate health potion', objectId: 7643 },
          // HTML vinha com data:image (sem /api/things)
          { name: 'energy drink', objectId: 23545 },
          { name: 'yellow gem', objectId: 3037 },
          { name: 'blue gem', objectId: 3041 },
          { name: 'green gem', objectId: 3038 },
    ...
    },
    {
      ...
      damageElements: [{ element: 'fire', weight: 556 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
      ...
      drops: {
        ...
        semiRare: [
          ...
          { name: 'giant sapphire', objectId: 30061 },
          { name: 'giant topaz', objectId: 32623 },
          { name: 'fiery tear', objectId: 39040 },
          { name: 'portable flame', objectId: 39545 },
    ...
    },
    {
      ...
      // Loot shrunken head / bonelord eye+shield â The Gravedigger.
      ...
      damageElements: [{ element: 'fire', weight: 800 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
      ...
      drops: {
        ...
        uncommon: [
          ...
          { name: 'assassin dagger', objectId: 7404 },
          { name: 'blue gem', objectId: 3041 },
          // HTML vinha com data:image; 32621 no jogo Ã© enchanted ring of souls.
          { name: 'giant ruby', objectId: 30059 },
          { name: 'giant sapphire', objectId: 30061 },
          { name: 'small flask of eyedrops', objectId: 11512 },
          { name: 'giant amethyst', objectId: 32622 },
        ...
        semiRare: [
          // HTML vinha com data:image (sem /api/things)
          { name: 'deathly crypt rune', objectId: 52659 }
        ]
      }
    },
    {
      ...
      damageElements: [{ element: 'energy', weight: 7570 }, { element: 'death', weight: 1100 }, { element: 'fire', weight: 800 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 5, kind: 'resistente' },
        { element: 'earth', value: 0, kind: 'neutro' },
      ...
      drops: {
        ...
        uncommon: [
          ...
          { name: 'blue gem', objectId: 3041 },
          { name: 'green gem', objectId: 3038 },
          // HTML vinha com data:image (sem /api/things); 32620 no jogo Ã© ghost backpack.
          { name: 'giant topaz', objectId: 32623 },
          { name: 'giant emerald', objectId: 30060 },
          { name: 'giant sapphire', objectId: 30061 },
          { name: 'giant amethyst', objectId: 32622 }
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 1500 }, { element: 'earth', weight: 900 }],
      resistances: [
        { element: 'physical', value: 5, kind: 'resistente' },
        { element: 'energy', value: 5, kind: 'resistente' },
      ...
      drops: {
        ...
        rare: [
          ...
          { name: 'spooky hood', objectId: 32630 },
          // HTML vinha com data:image (sem /api/things)
          { name: 'spectral scrap of cloth', objectId: 32629 },
          { name: 'enchanted ring of souls', objectId: 32621 }
        ]
      }
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 1800 }],
      resistances: [
        { element: 'physical', value: 50, kind: 'resistente' },
        { element: 'energy', value: 50, kind: 'resistente' },
        { element: 'earth', value: 50, kind: 'resistente' },
      ...
      drops: {
        common: [
          ...
          { name: 'mysterious remains', objectId: 23509 },
          { name: 'odd organ', objectId: 23510 },
          // HTML vinha com data:image; ID padrÃ£o do spark sphere.
          { name: 'spark sphere', objectId: 23518 }
        ],
        uncommon: [
          { name: 'green crystal shard', objectId: 16121 },
    ...
    },
    {
      ...
      damageElements: [{ element: 'fire', weight: 1700 }, { element: 'physical', weight: 1250 }, { element: 'death', weight: 1000 }, { element: 'energy', weight: 800 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'fire', weight: 850 }, { element: 'death', weight: 350 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 950 }, { element: 'earth', weight: 500 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'earth', weight: 3200 }, { element: 'physical', weight: 1350 }, { element: 'death', weight: 350 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: -10, kind: 'fraco' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      drops: {
        ...
        semiRare: [
          ...
          // HTML vinha com data:image (sem /api/things)
          { name: 'fiery crypt rune', objectId: 52657 }
        ]
      }
    },
    {
      ...
      drops: {
        ...
        semiRare: [
          ...
          { name: 'shard', objectId: 7290 },
          // HTML vinha com data:image (sem /api/things)
          { name: 'icy crypt rune', objectId: 52658 }
        ]
      }
    },
    {
      ...
      drops: {
        ...
        rare: [
          ...
          // HTML vinha sÃ³ com abreviaÃ§Ã£o (sem /api/things)
          { name: 'demon in a golden box', objectId: 50063 },
          { name: 'demon in a red box', objectId: 50062 }
        ]
      }
    },
    {
    ...
    },
    {
      ...
      drops: {
        ...
        rare: [
          ...
          // HTML vinha com data:image (sem /api/things)
          { name: 'bag you desire', objectId: 34109 }
        ]
      }
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 2400 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      drops: {
        common: [
          { name: 'crystal coin', objectId: 3043 },
          // HTML vinha com data:image (sem /api/things)
          { name: 'vial of hatred', objectId: 33927 }
        ],
        uncommon: [
          { name: 'giant sapphire', objectId: 30061 },
          { name: 'giant topaz', objectId: 32623 },
    ...
    },
    {
      ...
      damageElements: [{ element: 'ice', weight: 3200 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 15, kind: 'resistente' },
    ...
    },
    {
      ...
      drops: {
        ...
        rare: [
          { name: 'the skull of a beast', objectId: 34075 },
          // HTML vinha com data:image (sem /api/things)
          { name: 'figurine of spite', objectId: 33952 },
          { name: "spite's spirit", objectId: 33926 },
          { name: 'bag you desire', objectId: 34109 }
        ]
      }
    },
    {
      ...
      damageElements: [{ element: 'energy', weight: 927 }],
      resistances: [
        { element: 'physical', value: 0, kind: 'neutro' },
        { element: 'energy', value: 0, kind: 'neutro' },
        { element: 'earth', value: 0, kind: 'neutro' },
      ...
      drops: {
        ...
        uncommon: [
          ...
          { name: 'ultimate health potion', objectId: 7643 },
          { name: 'violet crystal shard', objectId: 16120 },
          { name: 'crystallized anger', objectId: 23507 },
          { name: 'energy vein', objectId: 23508 },
          { name: 'giant shimmering pearl', objectId: 282 },
          { name: 'odd organ', objectId: 23510 },
          { name: 'plasmatic lightning', objectId: 23520 },
          { name: 'green gem', objectId: 3038 },
        ...
        semiRare: [
          // HTML vinha com data:image (sem /api/things)
          { name: 'devourer core', objectId: 23686 },
    ...
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 2700 }, { element: 'death', weight: 2000 }],
      resistances: [
        { element: 'physical', value: 10, kind: 'resistente' },
        { element: 'energy', value: 3, kind: 'resistente' },
        { element: 'earth', value: 0, kind: 'neutro' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'death', weight: 1000 }],
      resistances: [
      ...
      drops: {
        ...
        rare: [
          // HTML vinha sÃ³ com abreviaÃ§Ã£o (sem /api/things)
          { name: 'darklight geode', objectId: 43900 },
          { name: 'bag you covet', objectId: 43860 }
        ]
      }
    },
    {
      ...
      damageElements: [{ element: 'death', weight: 5200 }, { element: 'physical', weight: 2800 }, { element: 'earth', weight: 600 }],
      resistances: [
        { element: 'physical', value: 15, kind: 'resistente' },
        { element: 'energy', value: 15, kind: 'resistente' },
        { element: 'earth', value: 15, kind: 'resistente' },
      ...
      drops: {
        ...
        rare: [
          // HTML vinha sÃ³ com abreviaÃ§Ã£o (sem /api/things)
          { name: 'cursed wood', objectId: 43899 },
          { name: 'bag you covet', objectId: 43860 }
        ]
      }
    },
    {
      ...
      damageElements: [{ element: 'death', weight: 5900 }, { element: 'physical', weight: 1000 }],
      resistances: [
        { element: 'physical', value: 15, kind: 'resistente' },
        { element: 'energy', value: 15, kind: 'resistente' },
        { element: 'earth', value: 15, kind: 'resistente' },
    ...
    },
    {
      ...
      damageElements: [{ element: 'energy', weight: 3500 }, { element: 'death', weight: 600 }, { element: 'physical', weight: 500 }],
      resistances: [
        { element: 'physical', value: 15, kind: 'resistente' },
        { element: 'energy', value: 15, kind: 'resistente' },
        { element: 'earth', value: 15, kind: 'resistente' },
    ...
    },
    {
      ...
      drops: {
        ...
        rare: [
          ...
          { name: "megalomania's essence", objectId: 33928 },
          { name: 'bag you desire', objectId: 34109 }
        ]
      }
    },
    {
      ...
      damageElements: [{ element: 'physical', weight: 117 }],
      resistances: [
        { element: 'physical', value: 15, kind: 'resistente' },
        { element: 'energy', value: 15, kind: 'resistente' },
        { element: 'earth', value: 15, kind: 'resistente' },
  ...
  function normalizeDrop(drop) {
    ...
    // Nome basta: alguns loots do HTML vinham sÃ³ com data:image (sem objectId).
    if (!name) return null;
    return {
      name,
      objectId: objectId || 0,
  ...
  function normalizeBoss(raw) {
    ...
    return {
      ...
      damageElements: (Array.isArray(raw.damageElements) ? raw.damageElements : [])
        .map((d) => {
          if (!d) return null;
          if (typeof d === 'string') {
            const element = d.trim().toLowerCase();
            if (!element) return null;
            return { element, weight: 1, icon: elementImg(element) };
          }
          const element = String(d.element || d.name || '')
            .trim()
            .toLowerCase();
          if (!element) return null;
          const weight = Number(d.weight ?? d.value ?? 1);
          return {
            element,
